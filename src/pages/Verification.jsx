...
const Verification = () => {
    ...
    const handleSendVerifyCode = () => {
        axios({
            method: "post",
            url: "http://localhost:4000/user/send/number",
            data: { 
    ...
    const handleClickVerifyButton = () => {
        axios({
            ...
            method: "post",
            url: "http://localhost:4000/user/auth/number",
            data: { 
                phoneNumber: phoneNumber,
    ...
    const handleClickNextButton = () => {
        axios({
            ...
            method: 'post',
            url: 'http://localhost:4000/user/agreement',
            data: {
                userAgreement: [1, 1, 1]
            }
        }).then((response) => {
                ...
                <div className="agreecontainer">
                    ...
                    <div className="each_check_container">
                        <div className="each_check">
                            ...
                            <a href="https://univeus.oopy.io/c9401d02-7c38-41f5-ba28-8bcf1d857d8a" target="_blank" rel="noopener noreferrer" className="termslink">보기</a>
                        </div>
                        <div className="each_check">
                            <div className="checkline">
                            ...
                            <a href="https://univeus.oopy.io/4f621393-467a-4e61-b8f8-76ada7cc9b99" target="_blank" rel="noopener noreferrer" className="termslink">보기</a>
                        </div>
                        <div className="each_check">
                            <div className="checkline">
                            ...
                            <a href="https://univeus.oopy.io/6157f35b-c400-4cc5-baa5-235de47b255a" target="_blank" rel="noopener noreferrer" className="termslink">보기</a>
                        </div>
                    </div>
                </div>
                <div className="nextbutton">
                    {isVerified === 1 && isCheckedAll === true ? <Button type={'floating'} content={'다음'} onClick={handleClickNextButton} /> :
